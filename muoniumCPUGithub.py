...
# --Parameters--
NumberOfSlits = 1000 # Number of slits in grating 1
NumberOfSlits2 = 10000 # Number of slits in grating 2
SlitLength = 50 # Length of the slit (nm)
SourcesPerSlit = 500 # Sources per slit
...
NumObservationPoints2 = 1 # Number of observation points in grating 2
NumObservationPoints3 = 2000000 # Number of observation points in grating 3
OSLength2 = 1e7 # Length of observation screen of grating 2 (nm) (Default is 1e7 which is the length of the grating)
OSLength3 = 2000000 # Length of observation screen of grating 3 (nm) (Default is 1e7 which is the length of the grating)
...
G2P = np.zeros(NumberOfSlits2 * SourcesPerSlit, dtype=complex128) # Phases of the source points on grating 2
G2U = np.zeros(NumberOfSlits2 * SourcesPerSlit, dtype=complex128) # Amplitudes of the source points on grating 2
