...
N0 = 1 # Index of refraction of x-rays in a vacuum.
N1 = 1-0.000141727127 # Index of refraction of x-rays in silicon nitride.
Wavelength = 0.56 # Wavelength of x-rays in vacuum (nm).
...
def calcs(y, o, u1, P1Slit, P1Closed, I2, wavelength, wavelength1, numberOfSlits, sourceSpacing, slitLength, sourcesPerSlit, numObservationPoints, d, k, initialAmplitude, initialPhase, mu, thickness, n0, n1):
    '''Function returns the intensity distribution of the source points in the back of grating 1 and also
    returns the intensity distribution of the source points in the front of grating 2.'''
