...
# --Parameters--
NumberOfSlitsX = 5 # Number of slit columns of grating 1
NumberOfSlitsY = 25 # Number of slit rows of grating 1
SlitLengthX = 500 # Slit length in x-dimension
SlitLengthY = 50 # Slit length in y-dimension
SourcesPerSlitX = 1000 # Number of source point columns in each slit
SourcesPerSlitY = 100 # Number of source point rows in each slit
...
NumObservationPointsX = 1000 # Number of observation points in x-dimension
NumObservationPointsY = 1000 # Number of observation points in y-dimension
