...
OSLengthX = 0.5e6 # Length of observation screen in x-dimension (nm) (1e7 is the default which is the length of the grating in the x-dimension)
OSLengthY = 0.5e6 # Length of observation screen in y-dimension (nm) (1e7 is the default which is the length of the grating in the y-dimension)
